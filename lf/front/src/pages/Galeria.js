        ...
        <div>
            ...
            <main className="galeria">
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img1.jpg" alt="Imagen 1" />
                ...
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img2.jpg" alt="Imagen 2" />
                ...
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img3.jpg" alt="Imagen 3" />
                ...
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img4.jpg" alt="Imagen 4" />
                ...
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img5.jpg" alt="Imagen 5" />
                ...
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img6.jpg" alt="Imagen 6" />
                        <h3>Cocina limpia</h3>
                ...
                <div className="imagen">
                    <div className="item">
                        <img src="public/img/galeria/img7.jpg" alt="Imagen 7" />
                        <h3>Luz natural</h3>
